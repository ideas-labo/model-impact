...
*Result*: `PickleLocker\_[tuner_name]\_results/Data\_[big\small]/[Data_name]/[model_name]\_[seed_num].csv`  <br>
- e.g. "./PickleLocker_atconf_results/Data_big/7z/RF_seed101.csv"<br>

*Model*: `PickleLocker\_[tuner_name]\_results/Data\_[big\small]/[Data_name]/[model_name]\_[seed_num]\_[step_num].p`  <br>
